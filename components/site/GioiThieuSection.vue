<template>
  <section id="gioi-thieu" class="section reveal">
    <div class="container about-grid">
      <div class="about-media">
        <div class="about-photo">
          <img src="/giới thiệu.png" alt="Giới thiệu DriveHub" class="about-img" />
        </div>
        <div class="about-badge">
          <strong>15<i>+</i></strong>
          <span>Năm kinh nghiệm</span>
        </div>
        <div class="about-badge two">
          <strong>98<i>%</i></strong>
          <span>Hài lòng HV</span>
        </div>
      </div>
